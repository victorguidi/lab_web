...
const ProjectCard: React.FC<Project> = ({
  ...
  return (
    <div id={id} className="flex flex-col bg-[#010101] border border-[#67DBFF] rounded-lg p-2 w-fill  h-[650px] font-bold text-white overflow-auto">
      ...
      <div className="flex flex-col justify-between h-[50%]">
        <div className="flex flex-col h-3/4">
          ...
          <div className="w-full h-4 bg-gray-200 rounded-full mb-2">
            <div className="h-full bg-[#0E192D] rounded-full" style={{ width: `${projectProgress}%` }}>{projectProgress == 100 ? "Completed" : `${projectProgress}%`}</div>
          </div>
        </div>
