...
export default function Navbar() {
  return (
    <nav className="flex flex-row items-center w-full h-[10%] text-light-text dark:text-dark-text">
      ...
      <div className="flex w-1/2 h-full justify-end items-center gap-2 p-6">
        <div className="flex md:w-1/6 justify-between">
          <button className="flex w-[5%] h-auto text-xl font-bold">
          ...
          {/* <Link to="/projects/"><button className=" text-xl font-bold border border-black rounded p-2">projects</button></Link> */}
          <button className="flex w-[5%] h-auto text-xl font-bold">
            <Link to={"/resume"}>
